...
void setup()
{
 ...
 // Buzzer
  ...
  while (digitalRead(BUTTON_START_PIN) != LOW)
  {
    ...
    else if (digitalRead(BUTTON_SUB_PIN) == LOW)
    {
  ...
  timer_10ms_init = timer_10ms;
delay(10);
  Timer1.initialize(10000);//10ms isr
...
int TimeUpdate(int time_input)
{
  ...
  second = time_input / 100;
  msecond = time_input % 100;
